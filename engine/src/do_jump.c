...
static struct ship_data *alien_portal;
static short jump_portal_age;
static int jump_portal_gv;
static char jump_portal_name[128];
static short jump_portal_units;
static struct species_data *other_species;
static int other_species_number;
static int using_alien_portal;
