...
char **argument, *shipName(), input_abbr[32];
...
int getClassAbbr(char *arg);

void get_species(void);

void save_species(void);
...
char *shipName(struct ship_data *ship);
...
void set_species(void) {
    ...
    getClassAbbr(argument[next_arg++]);
...
void set_ship(void) {
    ...
    switch (abbr_type) {
        case ITEM_CLASS:
            ...
            printf("SP %s, %s, %ld %ss", species->name, shipName(ship),
        ...
        default:
            ...
            if (strcasecmp(argument[next_arg], "x") == 0) {
                printf("SP %s, %s, x = %d", species->name, shipName(ship),
                       ship->x);
                ...
                printf("SP %s, %s, y = %d", species->name, shipName(ship),
                       ship->y);
                ...
                printf("SP %s, %s, z = %d", species->name, shipName(ship),
                       ship->z);
                ...
                printf("SP %s, %s, pn = %d", species->name, shipName(ship),
                       ship->pn);
                ...
                printf("SP %s, %s, loading_point = %d", species->name,
                       shipName(ship), ship->loading_point);
                ...
                printf("SP %s, %s, unloading_point = %d", species->name,
                       shipName(ship), ship->unloading_point);
                ...
                printf("SP %s, %s, age = %d turns", species->name, shipName(ship),
                       ship->age);
